...
Elm.BoxesAndBubbles = Elm.BoxesAndBubbles || {};
Elm.BoxesAndBubbles.make = function (_elm) {
   "use strict";
   _elm.BoxesAndBubbles = _elm.BoxesAndBubbles || {};
   if (_elm.BoxesAndBubbles.values)
   return _elm.BoxesAndBubbles.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "BoxesAndBubbles",
   $Basics = Elm.Basics.make(_elm),
   $BoxesAndBubblesBodies = Elm.BoxesAndBubblesBodies.make(_elm),
   $BoxesAndBubblesEngine = Elm.BoxesAndBubblesEngine.make(_elm),
   $List = Elm.List.make(_elm),
   $Math2D = Elm.Math2D.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var step = F3(function (gravity,
   ambient,
   bodies) {
      return A2($List.map,
      A2($BoxesAndBubblesEngine.update,
      gravity,
      ambient),
      A2($BoxesAndBubblesEngine.collide,
      _L.fromArray([]),
      bodies));
   });
   var run = F2(function (bodies,
   tick) {
   ...
   velocity) {
      return function () {
         ...
         {case "_Tuple2": return {_: {}
                                 ,inverseMass: 1 / (_v0._0 * _v0._1 * density)
                                 ,pos: pos
                                 ,restitution: restitution
                                 ,shape: $BoxesAndBubblesBodies.Box({ctor: "_Tuple2"
                                                                    ,_0: _v0._0 / 2
                                                                    ,_1: _v0._1 / 2})
                                 ,velocity: velocity};}
         _U.badCase($moduleName,
   ...
   var bubble = F5(function (radius,
   density,
   restitution,
   pos,
   velocity) {
      return {_: {}
             ,inverseMass: 1 / ($Basics.pi * radius * radius * density)
             ,pos: pos
             ,restitution: restitution
             ,shape: $BoxesAndBubblesBodies.Bubble(radius)
             ,velocity: velocity};
   });
   _elm.BoxesAndBubbles.values = {_op: _op
                                 ,bubble: bubble
                                 ,box: box
                                 ,bounds: bounds
                                 ,step: step
...
Elm.BoxesAndBubblesBodies = Elm.BoxesAndBubblesBodies || {};
Elm.BoxesAndBubblesBodies.make = function (_elm) {
   "use strict";
   _elm.BoxesAndBubblesBodies = _elm.BoxesAndBubblesBodies || {};
   if (_elm.BoxesAndBubblesBodies.values)
   return _elm.BoxesAndBubblesBodies.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "BoxesAndBubblesBodies",
   $Math2D = Elm.Math2D.make(_elm);
   ...
   var Body = F6(function (a,
   b,
   c,
   d,
   e,
   f) {
      return _U.insert("shape",
      e,
      _U.insert("restitution",
      d,
      _U.insert("inverseMass",
      c,
      _U.insert("velocity",
      b,
      _U.insert("pos",a,f)))));
   });
   _elm.BoxesAndBubblesBodies.values = {_op: _op
                                       ,Body: Body
                                       ,Box: Box
                                       ,Bubble: Bubble};
   return _elm.BoxesAndBubblesBodies.values;
};
Elm.BoxesAndBubblesEngine = Elm.BoxesAndBubblesEngine || {};
Elm.BoxesAndBubblesEngine.make = function (_elm) {
   "use strict";
   _elm.BoxesAndBubblesEngine = _elm.BoxesAndBubblesEngine || {};
   if (_elm.BoxesAndBubblesEngine.values)
   return _elm.BoxesAndBubblesEngine.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "BoxesAndBubblesEngine",
   $Basics = Elm.Basics.make(_elm),
   $BoxesAndBubblesBodies = Elm.BoxesAndBubblesBodies.make(_elm),
   $List = Elm.List.make(_elm),
   $Math2D = Elm.Math2D.make(_elm);
   var update = F3(function (gravity,
   force,
   body) {
      return function () {
         var posNew = A2($Math2D.plus,
         body.pos,
         body.velocity);
         var acceleration = A2($Math2D.mul2,
         force,
         body.inverseMass);
         var accelGravity = _U.eq(body.inverseMass,
         0) ? {ctor: "_Tuple2"
              ,_0: 0
              ,_1: 0} : gravity;
         var velocityNew = $Math2D.plus(accelGravity)(A2($Math2D.plus,
         body.velocity,
         acceleration));
   ...
   var resolveCollision = F3(function (_v0,
   b0,
   b1) {
      return function () {
         return function () {
            var relativeVelocity = A2($Math2D.minus,
            b1.velocity,
            b0.velocity);
            var velocityAlongNormal = A2($Math2D.dot,
            relativeVelocity,
            _v0.normal);
            return _U.eq(_v0.penetration,
            0) || _U.cmp(velocityAlongNormal,
            0) > 0 ? {ctor: "_Tuple2"
                     ,_0: b0
                     ,_1: b1} : function () {
               var invMassSum = b0.inverseMass + b1.inverseMass;
               var restitution = A2($Basics.min,
               b0.restitution,
               b1.restitution);
               var j = (0 - (1 + restitution)) * velocityAlongNormal / invMassSum;
               var impulse = A2($Math2D.mul2,
               _v0.normal,
               j);
               return {ctor: "_Tuple2"
                      ,_0: _U.replace([["velocity"
                                       ,A2($Math2D.minus,
                                       b0.velocity,
                                       A2($Math2D.mul2,
                                       impulse,
   ...
   var CollisionResult = F2(function (a,
   b) {
      return {_: {}
             ,normal: a
             ,penetration: b};
   });
   var collisionBubbleBubble = F3(function (b0b1,
   radius0,
   radius1) {
      return function () {
         var distanceSq = $Math2D.lenSq(b0b1);
         var radiusb0b1 = radius0 + radius1;
         return _U.eq(distanceSq,
         0) ? A2(CollisionResult,
         {ctor: "_Tuple2",_0: 1,_1: 0},
         radius0) : _U.cmp(distanceSq,
         radiusb0b1 * radiusb0b1) > -1 ? A2(CollisionResult,
         {ctor: "_Tuple2",_0: 1,_1: 0},
         0) : function () {
            var d = $Basics.sqrt(distanceSq);
            return A2(CollisionResult,
            A2($Math2D.div2,b0b1,d),
            radiusb0b1 - d);
         }();
      }();
   });
   var collisionBoxBox = F2(function (_v2,
   _v3) {
      return function () {
         switch (_v3.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return function () {
                         ...
                         0) > 0 ? _U.cmp(ox,
                         oy) < 0 ? _U.cmp(nx,
                         0) < 0 ? A2(CollisionResult,
                         {ctor: "_Tuple2",_0: -1,_1: 0},
                         ox) : A2(CollisionResult,
                         {ctor: "_Tuple2",_0: 1,_1: 0},
                         ox) : _U.cmp(ny,
                         0) < 0 ? A2(CollisionResult,
                         {ctor: "_Tuple2",_0: 0,_1: -1},
                         oy) : A2(CollisionResult,
                         {ctor: "_Tuple2",_0: 0,_1: 1},
                         oy) : A2(CollisionResult,
                         {ctor: "_Tuple2",_0: 1,_1: 0},
                         0);
   ...
   var collisionBoxBubble = F2(function (_v10,
   _v11) {
      return function () {
         switch (_v11.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return function () {
                         ...
                         c) ? {ctor: "_Tuple2"
                              ,_0: c
                              ,_1: false} : _U.cmp($Basics.abs(dx),
                         $Basics.abs(dy)) > 0 ? _U.cmp(cx,
                         0) > 0 ? {ctor: "_Tuple2"
                                  ,_0: {ctor: "_Tuple2"
                                       ,_0: boxX
                                       ,_1: cy}
                         ...
                         closest = $._0,
                         inside = $._1;
                         var normal = A2($Math2D.minus,
                         dist,
                         closest);
                         var normalLenSq = $Math2D.lenSq(normal);
                         return _U.cmp(normalLenSq,
                         _v11._1 * _v11._1) > 0 && $Basics.not(inside) ? A2(CollisionResult,
                         {ctor: "_Tuple2",_0: 1,_1: 0},
                         0) : function () {
                            var penetration = _v11._1 + $Basics.sqrt(normalLenSq);
                            return inside ? A2(CollisionResult,
                            A2($Math2D.mul2,
                            $Math2D.norm(normal),
                            -1),
                            penetration) : A2(CollisionResult,
                            $Math2D.norm(normal),
                            penetration);
                         }();
                      }();}
                 _U.badCase($moduleName,
                 "between lines 45 and 62");
              }();}
         _U.badCase($moduleName,
         "between lines 45 and 62");
      }();
   });
   var collision = F2(function (body0,
   body1) {
      return function () {
                 ...
                 switch (_v18._1.ctor)
                   {case "Box":
                      return function () {
                           ...
                           ,_0: body0.pos
                           ,_1: _v18._0._0});
                           return _U.replace([["normal"
                                              ,$Math2D.neg(res.normal)]],
                           res);
                        }();
                      case "Bubble":
                      return function () {
                           var b0b1 = A2($Math2D.minus,
                           body1.pos,
                           body0.pos);
                           return A3(collisionBubbleBubble,
                           b0b1,
                           _v18._0._0,
                           _v18._1._0);
                        }();}
   ...
   var collideWith = F3(function (a0,
   bodies,
   acc) {
      return function () {
         switch (bodies.ctor)
         {case "::": return function () {
                 var collisionResult = A2(collision,
                 a0,
                 bodies._0);
                 var $ = A3(resolveCollision,
                 collisionResult,
                 a0,
                 bodies._0),
                 a1 = $._0,
                 b1 = $._1;
                 return A3(collideWith,
                 a1,
                 bodies._1,
                 A2($List._op["::"],b1,acc));
              }();
   ...
   var collide = F2(function (acc,
   bodies) {
      return function () {
         switch (bodies.ctor)
         {case "::": return function () {
                 var _raw = A3(collideWith,
                 bodies._0,
                 bodies._1,
                 _L.fromArray([])),
                 $ = _raw.ctor === "::" ? _raw : _U.badCase($moduleName,
                 "on line 114, column 24 to 42"),
                 h1 = $._0,
                 t1 = $._1;
                 return A2(collide,
                 A2($List._op["::"],h1,acc),
   ...
   _elm.BoxesAndBubblesEngine.values = {_op: _op
                                       ,update: update
                                       ,collide: collide};
   return _elm.BoxesAndBubblesEngine.values;
};
...
Elm.Main.make = function (_elm) {
   ...
   $moduleName = "Main",
   $Basics = Elm.Basics.make(_elm),
   $BoxesAndBubbles = Elm.BoxesAndBubbles.make(_elm),
   $BoxesAndBubblesBodies = Elm.BoxesAndBubblesBodies.make(_elm),
   $Color = Elm.Color.make(_elm),
   ...
   var sinforce = function (t) {
      return {ctor: "_Tuple2"
             ,_0: $Basics.sin($Basics.radians(t / 1000)) * 50
             ,_1: 0};
   };
   var constgravity = function (t) {
      return {ctor: "_Tuple2"
             ,_0: {ctor: "_Tuple2"
                  ,_0: 0
                  ,_1: -0.2}
   ...
   0,
   $Time.fps(40)));
   var drawBody = function (_v0) {
      return function () {
         return function () {
            var info = $Graphics$Collage.toForm($Text.centered($Text.fromString(_v0.label)));
            var veloLine = $Graphics$Collage.traced($Graphics$Collage.solid($Color.red))(A2($Graphics$Collage.segment,
            {ctor: "_Tuple2",_0: 0,_1: 0},
            A2($Math2D.mul2,
            _v0.velocity,
            5)));
            var ready = function () {
               ...
               {case "Box":
                  return function () {
                       ...
                       w = $._0,
                       h = $._1;
                       return $Graphics$Collage.group(_L.fromArray([$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))(A2($Graphics$Collage.rect,
                                                                   w * 2,
                                                                   h * 2))
                  ...
                  case "Bubble":
                  return $Graphics$Collage.group(_L.fromArray([$Graphics$Collage.outlined($Graphics$Collage.solid($Color.black))($Graphics$Collage.circle(_v2._0))
                                                              ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                                                      ,_0: 0
                                                                                      ,_1: _v2._0 + 16})(info)
                                                              ,veloLine]));}
   ...
   var bodyLabel = F2(function (restitution,
   inverseMass) {
      return $String.concat(_L.fromArray(["e = "
                                         ,$Basics.toString(restitution)
                                         ,"\nm = "
                                         ,$Basics.toString($Basics.round(1 / inverseMass))]));
   });
   var e0 = 0.8;
   var inf = 1 / 0;
   var someBodies = A2($Basics._op["++"],
   _L.fromArray([A5($BoxesAndBubbles.bubble,
                30,
                1,
                e0,
                {ctor: "_Tuple2",_0: -80,_1: 0},
                {ctor: "_Tuple2",_0: 1.5,_1: 0})
                ,A5($BoxesAndBubbles.bubble,
                70,
                inf,
                0,
                {ctor: "_Tuple2",_0: 80,_1: 0},
   ...
   e0,
   {ctor: "_Tuple2",_0: 0,_1: 0}));
   var labeledBodies = A2($List.map,
   function (b) {
      return _U.insert("label",
      A2(bodyLabel,
      b.restitution,
      b.inverseMass),
      b);
...
Elm.Math2D = Elm.Math2D || {};
Elm.Math2D.make = function (_elm) {
   "use strict";
   _elm.Math2D = _elm.Math2D || {};
   if (_elm.Math2D.values)
   return _elm.Math2D.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $moduleName = "Math2D",
   $Basics = Elm.Basics.make(_elm);
   var lenSq = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return _v0._0 * _v0._0 + _v0._1 * _v0._1;}
         _U.badCase($moduleName,
         "on line 36, column 15 to 24");
      }();
   };
   var neg = function (_v4) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: 0 - _v4._1};}
         _U.badCase($moduleName,
         "on line 32, column 14 to 19");
      }();
   };
   var abs2 = function (_v8) {
      return function () {
         switch (_v8.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: $Basics.abs(_v8._0)
                   ,_1: $Basics.abs(_v8._1)};}
         _U.badCase($moduleName,
         "on line 29, column 15 to 27");
      }();
   };
   var mul2 = F2(function (_v12,
   a) {
      return function () {
         switch (_v12.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v12._1 * a};}
         _U.badCase($moduleName,
         "on line 25, column 17 to 25");
      }();
   });
   var div2 = F2(function (_v16,
   a) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v16._1 / a};}
         _U.badCase($moduleName,
         "on line 22, column 17 to 25");
      }();
   });
   var norm = function (v) {
      return div2(v)($Basics.sqrt(lenSq(v)));
   };
   var dot = F2(function (_v20,
   _v21) {
      return function () {
         switch (_v21.ctor)
         {case "_Tuple2":
            return function () {
                 switch (_v20.ctor)
                 {case "_Tuple2":
                    return _v20._0 * _v21._0 + _v20._1 * _v21._1;}
                 _U.badCase($moduleName,
                 "on line 18, column 23 to 36");
              }();}
         _U.badCase($moduleName,
         "on line 18, column 23 to 36");
      }();
   });
   var mul = F2(function (_v28,
   _v29) {
      return function () {
         switch (_v29.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v28._1 * _v29._1};}
                 _U.badCase($moduleName,
                 "on line 15, column 24 to 36");
              }();}
         _U.badCase($moduleName,
         "on line 15, column 24 to 36");
      }();
   });
   var minus = F2(function (_v36,
   _v37) {
      return function () {
         switch (_v37.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v36._1 - _v37._1};}
                 _U.badCase($moduleName,
                 "on line 11, column 26 to 37");
              }();}
         _U.badCase($moduleName,
         "on line 11, column 26 to 37");
      }();
   });
   var plus = F2(function (_v44,
   _v45) {
      return function () {
         switch (_v45.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v44._1 + _v45._1};}
                 _U.badCase($moduleName,
                 "on line 8, column 25 to 36");
              }();}
         _U.badCase($moduleName,
         "on line 8, column 25 to 36");
      }();
   });
   _elm.Math2D.values = {_op: _op
                        ,plus: plus
                        ,minus: minus
                        ,mul: mul
                        ,dot: dot
